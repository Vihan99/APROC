...
public abstract class FlexBox {
    ...
    public int colPrint;
    public boolean rBot;
    public boolean rCorn;
    public boolean sTop;
    public int qty;
    public double sa;
    public static double[] gradePriceMultiplier = {0.55, 0.65, 0.82, 0.98, 
                                                      1.5};
    ...
    public double getCalcSurfaceArea(){
        return sa;
    }
    /**
     * 
     ...
     */
    public double setCalcSurfaceArea(){
        double sa;
        sa = (2 * dim[0] * dim[2]) + 
             (2 * dim[1] * dim[0]) +
             (2 * dim[2] * dim[1]);
    ...
    public double calcBasePrice(){
        double bp;
        double area = getCalcSurfaceArea();
